      ...
      body: ListView(
        children: [
          ...
          _SettingsTile(
            ...
            onTap: () => context.push(AppRoutes.settingsSalon),
          ),
          const Divider(),
          ...
          _SettingsTile(
            ...
            onTap: () => context.push(AppRoutes.settingsMenus),
          ),
          _SettingsTile(
            icon: Icons.inventory_2_outlined,
            title: '在庫管理',
            subtitle: '商品在庫の確認・入出庫',
            onTap: () => context.push(AppRoutes.settingsInventory),
          ),
          _SettingsTile(
            icon: Icons.chat_bubble_outline,
            title: 'メッセージテンプレート',
            subtitle: 'SMS・LINE用メッセージの作成・編集',
            onTap: () => context.push(AppRoutes.settingsMessages),
          ),
          _SettingsTile(
            icon: Icons.campaign_outlined,
            title: 'キャンペーン管理',
            subtitle: 'VIP・休眠・誕生日顧客向けキャンペーンの作成',
            onTap: () => context.push(AppRoutes.settingsCampaign),
          ),
          _SettingsTile(
            icon: Icons.view_module_outlined,
            title: 'セットメニュー管理',
            subtitle: '複数メニューをまとめてセット価格・割引を設定',
            onTap: () => context.push(AppRoutes.settingsBundles),
          ),
          _SettingsTile(
            icon: Icons.auto_awesome_outlined,
            title: '自動化ルール',
            subtitle: '来店後・誕生日・長期未来店など自動メッセージ設定',
            onTap: () => context.push(AppRoutes.settingsAutomation),
          ),
          _SettingsTile(
          ...
          _SettingsTile(
            ...
            onTap: () => context.push(AppRoutes.settingsStaff),
          ),
          const Divider(),
          ...
          _SettingsTile(
            ...
            onTap: () => context.push(AppRoutes.settingsKpi),
          ),
          _SettingsTile(
            icon: Icons.loyalty_outlined,
            title: 'ポイント・会員設定',
            subtitle: '会員ランクとポイント倍率',
            onTap: () => context.push(AppRoutes.settingsLoyalty),
          ),
          _SettingsTile(
            icon: Icons.military_tech_outlined,
            title: '会員ランク管理',
            subtitle: 'ブロンズ・シルバー・ゴールド・プラチナのランク基準設定',
            onTap: () => context.push(AppRoutes.settingsTiers),
          ),
          _SettingsTile(
            icon: Icons.payments_outlined,
            title: 'キャッシュドロア',
            subtitle: 'レジ開設・締め設定',
            onTap: () => context.push(AppRoutes.settingsCash),
          ),
          _SettingsTile(
